    ...
    <div className="space-y-6">
          ...
          {top3.map((membro, index) => (
            ...
            >
              <div className="absolute top-2 right-2 opacity-100 z-10">
                <UnidadeBadge nome={membro.unidade} size="xl" />
              </div>
              ...
              <div className="relative flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-2xl font-bold mt-2">
                    {membro.totalPontos.toLocaleString("pt-BR")} pts
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="bg-black rounded-lg border border-gray-800 shadow-sm">
        <div className="p-4 border-b border-gray-800">
          <h2 className="text-lg font-semibold text-white">Ranking de Membros</h2>
        </div>
        ...
        <div className="p-4 flex flex-wrap gap-4">
          <div className="flex-1 min-w-[200px]">
            ...
            <input
              type="date"
              className="w-full px-3 py-2 rounded-md border border-gray-800 bg-black text-white"
              onChange={(e) =>
                  ...
                  >
                    ...
                    <td className="p-3">
                      <div className="flex justify-center">
                        <UnidadeBadge nome={membro.unidade} size="md" />
                      </div>
                    </td>
